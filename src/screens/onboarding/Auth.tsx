...
import { Button, Pressable, ScrollView, StyleSheet, Text, useWindowDimensions, View } from 'react-native'
            ...
            <Animated.View style={[styles.bottomSheet, bottomSheetAnimation]}>
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{marginVertical:20}}>
                        <Input
                            topIcon={<MaterialCommunityIcons name="email-multiple-outline" size={24} color={colors.text} />}
                            topText='Email'
